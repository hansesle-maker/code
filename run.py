...
def main(argv: List[str] | None = None) -> int:
    ...
    parser.add_argument("--exit-state", type=int, default=-2,
                        help="with --hysteresis, exit a long when 4h state <= this "
                             "(-1 = exit when TSI crosses below signal; -2 = hold until full reversal)")
